...
<html>
  ...
  <body>
    ...
    <h3 style="color: #0c6980;">BẢNG DỮ LIỆU TỪ CẢM BIẾN</h3>
    ...
    <table class="styled-table" id= "table_id">
      ...
      <tbody id="tbody_table_record">
        <?php
          ...
          $sql = 'SELECT * FROM datasensor_record ORDER BY date DESC, time DESC';
          foreach ($pdo->query($sql) as $row) {
           ...
           // echo '<td class="bdr">'. $row['id'] . '</td>';
			...
			echo '<td class="bdr">'. $row['vib'] . '</td>';
			echo '<td class="bdr">'. $row['gas'] . '</td>';
            echo '<td class="bdr">'. $row['temp'] . '</td>';
            echo '<td class="bdr">'. $row['humi'] . '</td>';
          //  echo '<td class="bdr">'. $row['air'] . '</td>';
            echo '<td class="bdr">'. $row['LED'] . '</td>';
            echo '<td class="bdr">'. $row['sound'] . '</td>';
